...
#define DAT_FILE_COLOUR_UNDEFINED (SHARED_COLOUR_UNDEFINED)
#define DAT_FILE_COLOUR_BLACK (SHARED_COLOUR_BLACK)
#define DAT_FILE_COLOUR_BLUE (SHARED_COLOUR_BLUE)
#define DAT_FILE_COLOUR_GREEN (SHARED_COLOUR_GREEN)
#define DAT_FILE_COLOUR_CYAN (SHARED_COLOUR_CYAN)
#define DAT_FILE_COLOUR_RED (SHARED_COLOUR_RED)
#define DAT_FILE_COLOUR_MAGENTA (SHARED_COLOUR_MAGENTA)
#define DAT_FILE_COLOUR_BROWN (SHARED_COLOUR_BROWN)
#define DAT_FILE_COLOUR_LIGHTGREY (SHARED_COLOUR_LIGHTGREY)
#define DAT_FILE_COLOUR_DARKGREY (SHARED_COLOUR_DARKGREY)
#define DAT_FILE_COLOUR_YELLOW (SHARED_COLOUR_YELLOW)
#define DAT_FILE_COLOUR_WHITE (SHARED_COLOUR_WHITE)
#define DAT_FILE_COLOUR_ORANGE (SHARED_COLOUR_ORANGE)
#define DAT_FILE_COLOUR_PURPLE (SHARED_COLOUR_PURPLE)
#define DAT_FILE_COLOUR_DARKBLUE (SHARED_COLOUR_DARKBLUE)
#define DAT_FILE_COLOUR_DARKGREEN (SHARED_COLOUR_DARKGREEN)
#define DAT_FILE_COLOUR_DARKRED (SHARED_COLOUR_DARKRED)
#define DAT_FILE_COLOUR_DARKYELLOW (SHARED_COLOUR_DARKYELLOW)
#define DAT_FILE_COLOUR_AQUA (SHARED_COLOUR_AQUA)
